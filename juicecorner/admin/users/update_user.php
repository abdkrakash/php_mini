...
// التحقق من وجود User ID في الرابط
if (isset($_GET['user_id']) && is_numeric($_GET['user_id'])) {
    $user_id = $_GET['user_id'];

    // جلب بيانات المستخدم باستخدام User ID
...
// معالجة تحديث المستخدم عند إرسال النموذج
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update'])) {
    ...
    // تحديث بيانات المستخدم باستخدام User ID
    ...
    // إعادة التوجيه إلى صفحة عرض المستخدمين بعد التحديث
